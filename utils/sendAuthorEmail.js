...
// emailService.js
const sendAuthorEmail = (to, userEmail , bookTitle , price , quantity , totalAmount ) => {
    ...
    const mailOptions = {
      ...
      to: to,
      subject: `New Purchase has been generated.`,
      html: `
        <div style="max-width: 700px; margin:auto; border: 10px solid #ddd; padding: 50px 20px; font-size: 110%;">
          <h2 style="text-align: center; text-transform: uppercase;color: teal;">A new purchase has been generated!</h2>
          <p>${userEmail} has successfully purchased the following book:</p>
...
module.exports = sendAuthorEmail;
